  ...
  if (available === 0) {
    return (
      <main className="flex flex-1 flex-col">
        ...
        <Link
          href="/"
          className="mt-2 self-start rounded-full border border-cream/20 surface-8 px-4 py-2 text-[13px] text-cream transition-colors duration-200 hover:bg-cream/16 focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none"
        >
          Back to start
        </Link>
      </main>
